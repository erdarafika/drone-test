    ...
    el-row(:gutter='12' style="margin-top: 10px;")
      el-col(:span='12')
        el-card(shadow='never')
          el-row(:gutter='12')
            el-col(:span='18')
              el-select(v-model='suspenseId' name="suspenseId" placeholder='Select Suspense' style="width:100%;" filterable)
          ...
          el-table(:data='temp.suspenses', style='width: 100%' :show-header='false')
            el-table-column(type="index" label='Date', width='10')
      ...
      el-col(:span='12')
        el-card(shadow='never')
          el-row(:gutter='12')
            el-col(:span='18')
              el-select(v-model='billingId' name="billingId" placeholder='Select Billing' style="width:100%" filterable)
