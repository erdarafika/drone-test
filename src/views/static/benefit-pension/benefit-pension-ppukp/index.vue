...
app-container
  ...
  el-table(:key='tableKey', v-loading='listLoading', :data='filterredList', fit='', highlight-current-row='', style='width: 100%;')
    el-table-column(:label="`Code`", align='left' prop='code')
    el-table-column(:label="`Group Source`", align='left' prop='groupSource')
    el-table-column(:label="`Member`", align='left' prop='member')
    el-table-column(:label="`Group Destination`", align='left' prop='groupDestination')
    el-table-column(:label="`Status`", align='left' prop='status')
    el-table-column(:label="`Sub Benefit Type`", align='left' prop='subBenefitType')
    el-table-column(:label="`Type`", align='left' prop='type')
    el-table-column(:label="`Withdrawal Now`", align='left' prop='withdrawalNow')
    el-table-column(:label="`Withdrawal Amount`", align='left' prop='withdrawalAmount')
