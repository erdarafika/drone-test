...
app-container
  ...
  el-table(:key='tableKey', v-loading='listLoading', :data='filterredList', fit='', highlight-current-row='', style='width: 100%;')
    el-table-column(:label="$t('fundSwitching.companyName')", align='left')
      template(slot-scope='scope')
        span {{ scope.row.company }}
    el-table-column(:label="$t('fundSwitching.groupName')", align='left')
      template(slot-scope='scope')
        span {{ scope.row.group }}
    el-table-column(:label="$t('fundSwitching.memberName')", align='left')
      template(slot-scope='scope')
        span {{ scope.row.member }}
    el-table-column(:label="$t('fundSwitching.status')", align='left')
      template(slot-scope='scope')
