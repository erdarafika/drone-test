...
app-container
  ...
  el-table(:data='rolesList', style='width: 100%;margin-top:30px;', border='')
    el-table-column(align='center', :label='$t("role.roleKey")', width='220')
    ...
    el-table-column(align='center', label='')
      template(slot-scope='scope')
        ...
        el-button(type='danger', size='small', @click='handleDelete(scope)')
          | {{ $t('table.delete') }}
  el-dialog(:visible.sync='dialogVisible', :title='getDialogHeader(dialogType)')
    el-form(:model='role', label-width='180px', label-position='left')
      ...
      el-form-item(:label='$t("role.menus")')
        el-tree.permission-tree(ref='tree', :check-strictly='checkStrictly', :data='routesData', :props='defaultProps', show-checkbox='', node-key='path')
