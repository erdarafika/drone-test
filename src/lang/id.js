export default {
  route: {
    ...
    config: 'Pengaturan',
    batchManagement: 'Manajemen Batch',
    alteration: 'Pengubahan',
    alterationDocument: 'Dokumen',
    alterationData: 'Data',
    benefitPension: 'Manfaat Pensiun',
    benefitPensionPPUKP: 'Manfaat Pensiun PPUKP',
    ...
    contributionSimulator: 'Simulator Kontribusi',
    emailStatus: 'Status Email',
    feeManagement: 'Manajemen Biaya',
    feeManagementSummary: 'Ringkasan Biaya',
    feeManagementList: 'Daftar Biaya',
    feeManagementToFounder: 'Biaya Untuk Pemilik'
  },
  // GLOBAL
  validatorMessage: {
  ...
  membership: {
    ...
    cellPhoneNumberPrefix: 'Awalan Nomor Telepon',
    certificateNumber: 'Nomor Sertifikat',
    certificateStatus: 'Status',
    classPlanId: 'ID Rencana Kelas',
    companyId: 'ID Perusahaan',
    dateOfBirth: 'Tanggal Lahir',
    dobPlace: 'Tempat Lahir',
    effectiveDate: 'Tanggal Efektif',
    email: 'Email',
    ...
    phoneNumberPrefix: 'Awalan Nomor Telepon',
    proposalNumber: 'Nomor Proposal',
    purpose: 'Tujuan',
